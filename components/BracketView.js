...
export function BracketView({ fixture = [] }) {
  ...
  const getMock16 = () => [
    { num: 73, a: '1º Grupo A', b: '3º Grupo C/D/E', label: '16avos 1' },
    { num: 74, a: '2º Grupo A', b: '2º Grupo B', label: '16avos 2' },
    { num: 75, a: '1º Grupo B', b: '3º Grupo A/C/D', label: '16avos 3' },
    { num: 76, a: '1º Grupo C', b: '3º Grupo F/G/H', label: '16avos 4' },
    { num: 77, a: '2º Grupo C', b: '2º Grupo D', label: '16avos 5' },
    { num: 78, a: '1º Grupo D', b: '3º Grupo I/J/K', label: '16avos 6' },
    { num: 79, a: '1º Grupo E', b: '3º Grupo A/B/C', label: '16avos 7' },
    { num: 80, a: '2º Grupo E', b: '2º Grupo F', label: '16avos 8' },
    { num: 81, a: '1º Grupo F', b: '3º Grupo I/J/L', label: '16avos 9' },
    { num: 82, a: '1º Grupo G', b: '3º Grupo J/K/L', label: '16avos 10' },
    { num: 83, a: '2º Grupo G', b: '2º Grupo H', label: '16avos 11' },
    { num: 84, a: '1º Grupo H', b: '3º Grupo D/E/F', label: '16avos 12' },
    { num: 85, a: '1º Grupo I', b: '3º Grupo G/H/I', label: '16avos 13' },
    { num: 86, a: '2º Grupo I', b: '2º Grupo J', label: '16avos 14' },
    { num: 87, a: '1º Grupo J', b: '3º Grupo E/F/G', label: '16avos 15' },
    { num: 88, a: '1º Grupo K', b: '2º Grupo L', label: '16avos 16' },
  ];

  const getMock8 = () => [
    { num: 89, a: 'Ganador M73', b: 'Ganador M74', label: 'Octavos 1' },
    { num: 90, a: 'Ganador M75', b: 'Ganador M76', label: 'Octavos 2' },
    { num: 91, a: 'Ganador M77', b: 'Ganador M78', label: 'Octavos 3' },
    { num: 92, a: 'Ganador M79', b: 'Ganador M80', label: 'Octavos 4' },
    { num: 93, a: 'Ganador M81', b: 'Ganador M82', label: 'Octavos 5' },
    { num: 94, a: 'Ganador M83', b: 'Ganador M84', label: 'Octavos 6' },
    { num: 95, a: 'Ganador M85', b: 'Ganador M86', label: 'Octavos 7' },
    { num: 96, a: 'Ganador M87', b: 'Ganador M88', label: 'Octavos 8' },
  ];

  const getMock4 = () => [
    { num: 97, a: 'Ganador M89', b: 'Ganador M90', label: 'Cuartos 1' },
    { num: 98, a: 'Ganador M91', b: 'Ganador M92', label: 'Cuartos 2' },
    { num: 99, a: 'Ganador M93', b: 'Ganador M94', label: 'Cuartos 3' },
