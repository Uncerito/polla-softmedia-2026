...
-- JORNADA 1
(1,  'México',               'Sudáfrica',            '2026-06-11 14:00:00-05', 'Grupos', 1, 'Grupo A',  'Estadio Ciudad de México',               'Ciudad de México'),
(2,  'República de Corea',        'Chequia',      '2026-06-11 21:00:00-05', 'Grupos', 1, 'Grupo A',  'Estadio Guadalajara',                'Guadalajara'),
(3,  'Canadá',               'Bosnia y Herzegovina', '2026-06-12 14:00:00-05', 'Grupos', 1, 'Grupo B',  'Estadio de Toronto',                    'Toronto'),
(4,  'EE. UU.',       'Paraguay',             '2026-06-12 20:00:00-05', 'Grupos', 1, 'Grupo D',  'Estadio Los Angeles',                 'Los Ángeles'),
(5,  'Catar',                'Suiza',                '2026-06-13 14:00:00-05', 'Grupos', 1, 'Grupo B',  'Estadio de la Bahía de San Francisco',              'Área de la Bahía de San Francisco'),
(6,  'Brasil',               'Marruecos',            '2026-06-13 17:00:00-05', 'Grupos', 1, 'Grupo C',  'Estadio Nueva York/Nueva Jersey',              'Nueva Jersey'),
(7,  'Haití',                'Escocia',              '2026-06-13 20:00:00-05', 'Grupos', 1, 'Grupo C',  'Estadio Boston',             'Boston'),
(8,  'Australia',            'Turquía',              '2026-06-13 23:00:00-05', 'Grupos', 1, 'Grupo D',  'Estadio BC Place Vancouver',                     'Vancouver'),
(9,  'Alemania',             'Curazao',              '2026-06-14 12:00:00-05', 'Grupos', 1, 'Grupo E',  'Estadio Houston',                  'Houston'),
(10, 'Países Bajos',         'Japón',                '2026-06-14 15:00:00-05', 'Grupos', 1, 'Grupo F',  'Estadio Dallas',                 'Dallas'),
(11, 'Costa de Marfil',      'Ecuador',              '2026-06-14 18:00:00-05', 'Grupos', 1, 'Grupo E',  'Estadio Filadelfia',      'Filadelfia'),
(12, 'Suecia',               'Túnez',                '2026-06-14 21:00:00-05', 'Grupos', 1, 'Grupo F',  'Estadio Monterrey',                 'Monterrey'),
(13, 'España',               'Islas de Cabo Verde',           '2026-06-15 11:00:00-05', 'Grupos', 1, 'Grupo H',  'Estadio Atlanta',        'Atlanta'),
(14, 'Bélgica',              'Egipto',               '2026-06-15 14:00:00-05', 'Grupos', 1, 'Grupo G',  'Estadio de Seattle',                  'Seattle'),
(15, 'Arabia Saudí',       'Uruguay',              '2026-06-15 17:00:00-05', 'Grupos', 1, 'Grupo H',  'Estadio Miami',            'Miami'),
(16, 'RI de Irán',                 'Nueva Zelanda',        '2026-06-15 20:00:00-05', 'Grupos', 1, 'Grupo G',  'Estadio Los Angeles',                 'Los Ángeles'),
(17, 'Francia',              'Senegal',              '2026-06-16 14:00:00-05', 'Grupos', 1, 'Grupo I',  'Estadio Nueva York/Nueva Jersey',              'Nueva Jersey'),
(18, 'Irak',                 'Noruega',              '2026-06-16 17:00:00-05', 'Grupos', 1, 'Grupo I',  'Estadio Boston',             'Boston'),
(19, 'Argentina',            'Argelia',              '2026-06-16 20:00:00-05', 'Grupos', 1, 'Grupo J',  'Estadio Kansas City',            'Kansas City'),
(20, 'Austria',              'Jordania',             '2026-06-16 23:00:00-05', 'Grupos', 1, 'Grupo J',  'Estadio de la Bahía de San Francisco',              'Área de la Bahía de San Francisco'),
(21, 'Portugal',             'RD Congo',             '2026-06-17 12:00:00-05', 'Grupos', 1, 'Grupo K',  'Estadio Houston',                  'Houston'),
(22, 'Inglaterra',           'Croacia',              '2026-06-17 15:00:00-05', 'Grupos', 1, 'Grupo L',  'Estadio Dallas',                 'Dallas'),
(23, 'Ghana',                'Panamá',               '2026-06-17 18:00:00-05', 'Grupos', 1, 'Grupo L',  'Estadio de Toronto',                    'Toronto'),
(24, 'Uzbekistán',           'Colombia',             '2026-06-17 21:00:00-05', 'Grupos', 1, 'Grupo K',  'Estadio Ciudad de México',               'Ciudad de México'),

-- JORNADA 2
(25, 'Chequia',      'Sudáfrica',            '2026-06-18 11:00:00-05', 'Grupos', 2, 'Grupo A',  'Estadio Atlanta',        'Atlanta'),
(26, 'Suiza',                'Bosnia y Herzegovina', '2026-06-18 14:00:00-05', 'Grupos', 2, 'Grupo B',  'Estadio Los Angeles',                 'Los Ángeles'),
(27, 'Canadá',               'Catar',                '2026-06-18 17:00:00-05', 'Grupos', 2, 'Grupo B',  'Estadio BC Place Vancouver',                     'Vancouver'),
(28, 'México',               'República de Corea',        '2026-06-18 20:00:00-05', 'Grupos', 2, 'Grupo A',  'Estadio Guadalajara',                'Guadalajara'),
(29, 'EE. UU.',       'Australia',            '2026-06-19 14:00:00-05', 'Grupos', 2, 'Grupo D',  'Estadio de Seattle',                  'Seattle'),
(30, 'Escocia',              'Marruecos',            '2026-06-19 17:00:00-05', 'Grupos', 2, 'Grupo C',  'Estadio Boston',             'Boston'),
(31, 'Brasil',               'Haití',                '2026-06-19 20:00:00-05', 'Grupos', 2, 'Grupo C',  'Estadio Filadelfia',      'Filadelfia'),
(32, 'Turquía',              'Paraguay',             '2026-06-19 23:00:00-05', 'Grupos', 2, 'Grupo D',  'Estadio de la Bahía de San Francisco',              'Área de la Bahía de San Francisco'),
(33, 'Países Bajos',         'Suecia',               '2026-06-20 12:00:00-05', 'Grupos', 2, 'Grupo F',  'Estadio Dallas',                 'Dallas'),
(34, 'Alemania',             'Costa de Marfil',      '2026-06-20 15:00:00-05', 'Grupos', 2, 'Grupo E',  'Estadio de Toronto',                    'Toronto'),
(35, 'Ecuador',              'Curazao',              '2026-06-20 19:00:00-05', 'Grupos', 2, 'Grupo E',  'Estadio Kansas City',            'Kansas City'),
(36, 'Túnez',                'Japón',                '2026-06-20 21:00:00-05', 'Grupos', 2, 'Grupo F',  'Estadio Monterrey',                 'Monterrey'),
(37, 'España',               'Arabia Saudí',       '2026-06-21 11:00:00-05', 'Grupos', 2, 'Grupo H',  'Estadio Atlanta',        'Atlanta'),
(38, 'Bélgica',              'RI de Irán',                 '2026-06-21 14:00:00-05', 'Grupos', 2, 'Grupo G',  'Estadio Los Angeles',                 'Los Ángeles'),
(39, 'Uruguay',              'Islas de Cabo Verde',           '2026-06-21 17:00:00-05', 'Grupos', 2, 'Grupo H',  'Estadio Miami',            'Miami'),
(40, 'Nueva Zelanda',        'Egipto',               '2026-06-21 20:00:00-05', 'Grupos', 2, 'Grupo G',  'Estadio BC Place Vancouver',                     'Vancouver'),
(41, 'Argentina',            'Austria',              '2026-06-22 12:00:00-05', 'Grupos', 2, 'Grupo J',  'Estadio Dallas',                 'Dallas'),
(42, 'Francia',              'Irak',                 '2026-06-22 16:00:00-05', 'Grupos', 2, 'Grupo I',  'Estadio Filadelfia',      'Filadelfia'),
(43, 'Noruega',              'Senegal',              '2026-06-22 19:00:00-05', 'Grupos', 2, 'Grupo I',  'Estadio Nueva York/Nueva Jersey',              'Nueva Jersey'),
(44, 'Jordania',             'Argelia',              '2026-06-22 22:00:00-05', 'Grupos', 2, 'Grupo J',  'Estadio de la Bahía de San Francisco',              'Área de la Bahía de San Francisco'),
(45, 'Portugal',             'Uzbekistán',           '2026-06-23 12:00:00-05', 'Grupos', 2, 'Grupo K',  'Estadio Houston',                  'Houston'),
(46, 'Inglaterra',           'Ghana',                '2026-06-23 15:00:00-05', 'Grupos', 2, 'Grupo L',  'Estadio Boston',             'Boston'),
(47, 'Panamá',               'Croacia',              '2026-06-23 18:00:00-05', 'Grupos', 2, 'Grupo L',  'Estadio de Toronto',                    'Toronto'),
(48, 'Colombia',             'RD Congo',             '2026-06-23 21:00:00-05', 'Grupos', 2, 'Grupo K',  'Estadio Guadalajara',                'Guadalajara'),

-- JORNADA 3 (Grupos Sincronizados)
(49, 'Brasil',               'Escocia',              '2026-06-24 16:00:00-05', 'Grupos', 3, 'Grupo C',  'Estadio Miami',            'Miami'),
(50, 'Marruecos',            'Haití',                '2026-06-24 16:00:00-05', 'Grupos', 3, 'Grupo C',  'Estadio Atlanta',        'Atlanta'),
(51, 'Suiza',                'Canadá',               '2026-06-24 13:00:00-05', 'Grupos', 3, 'Grupo B',  'Estadio BC Place Vancouver',                     'Vancouver'),
(52, 'Bosnia y Herzegovina', 'Catar',                '2026-06-24 13:00:00-05', 'Grupos', 3, 'Grupo B',  'Estadio de Seattle',                  'Seattle'),
(53, 'Chequia',      'México',               '2026-06-24 19:00:00-05', 'Grupos', 3, 'Grupo A',  'Estadio Ciudad de México',               'Ciudad de México'),
(54, 'Sudáfrica',            'República de Corea',        '2026-06-24 19:00:00-05', 'Grupos', 3, 'Grupo A',  'Estadio Monterrey',                 'Monterrey'),
(55, 'Curazao',              'Costa de Marfil',      '2026-06-25 15:00:00-05', 'Grupos', 3, 'Grupo E',  'Estadio Filadelfia',      'Filadelfia'),
(56, 'Alemania',             'Ecuador',              '2026-06-25 15:00:00-05', 'Grupos', 3, 'Grupo E',  'Estadio Nueva York/Nueva Jersey',              'Nueva Jersey'),
(57, 'Japón',                'Suecia',               '2026-06-25 18:00:00-05', 'Grupos', 3, 'Grupo F',  'Estadio Dallas',                 'Dallas'),
(58, 'Países Bajos',         'Túnez',                '2026-06-25 18:00:00-05', 'Grupos', 3, 'Grupo F',  'Estadio Kansas City',            'Kansas City'),
(59, 'EE. UU.',       'Turquía',              '2026-06-25 21:00:00-05', 'Grupos', 3, 'Grupo D',  'Estadio Los Angeles',                 'Los Ángeles'),
(60, 'Paraguay',             'Australia',            '2026-06-25 21:00:00-05', 'Grupos', 3, 'Grupo D',  'Estadio de la Bahía de San Francisco',              'Área de la Bahía de San Francisco'),
(61, 'Francia',              'Noruega',              '2026-06-26 13:00:00-05', 'Grupos', 3, 'Grupo I',  'Estadio Boston',             'Boston'),
(62, 'Senegal',              'Irak',                 '2026-06-26 13:00:00-05', 'Grupos', 3, 'Grupo I',  'Estadio de Toronto',                    'Toronto'),
(63, 'Egipto',               'RI de Irán',                 '2026-06-26 16:00:00-05', 'Grupos', 3, 'Grupo G',  'Estadio de Seattle',                  'Seattle'),
(64, 'Bélgica',              'Nueva Zelanda',        '2026-06-26 16:00:00-05', 'Grupos', 3, 'Grupo G',  'Estadio BC Place Vancouver',                     'Vancouver'),
(65, 'Islas de Cabo Verde',           'Arabia Saudí',       '2026-06-26 19:00:00-05', 'Grupos', 3, 'Grupo H',  'Estadio Houston',                  'Houston'),
(66, 'España',               'Uruguay',              '2026-06-26 19:00:00-05', 'Grupos', 3, 'Grupo H',  'Estadio Guadalajara',                'Guadalajara'),
(67, 'Inglaterra',           'Panamá',               '2026-06-27 16:00:00-05', 'Grupos', 3, 'Grupo L',  'Estadio Nueva York/Nueva Jersey',              'Nueva Jersey'),
(68, 'Croacia',              'Ghana',                '2026-06-27 16:00:00-05', 'Grupos', 3, 'Grupo L',  'Estadio Filadelfia',      'Filadelfia'),
(69, 'Argelia',              'Austria',              '2026-06-27 21:00:00-05', 'Grupos', 3, 'Grupo J',  'Estadio Kansas City',            'Kansas City'),
(70, 'Argentina',            'Jordania',             '2026-06-27 21:00:00-05', 'Grupos', 3, 'Grupo J',  'Estadio Dallas',                 'Dallas'),
(71, 'Portugal',             'Colombia',             '2026-06-27 18:30:00-05', 'Grupos', 3, 'Grupo K',  'Estadio Miami',            'Miami'),
(72, 'RD Congo',             'Uzbekistán',           '2026-06-27 18:30:00-05', 'Grupos', 3, 'Grupo K',  'Estadio Atlanta',        'Atlanta')
